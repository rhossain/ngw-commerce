        ...
        if ( isset( $data['component_settings']['category_products_sections'] ) && is_array( $data['component_settings']['category_products_sections'] ) ) {
            ...
            foreach ( $sections as $section ) {
                ...
                $clean_sections[] = array(
                    ...
                    'carouselNavigation'   => isset( $section['carouselNavigation'] ) ? (bool) $section['carouselNavigation'] : true,
                    'carouselPagination'   => isset( $section['carouselPagination'] ) ? (bool) $section['carouselPagination'] : true,
